...
public class HummingbirdAgent : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        if (trainingMode)
        {
            //Only reset flowers in the training when there is one agent per area
        ...
        //Zero out velocities so that movement stops befor a new episode begins
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        //Observe a normalize vector pointing to the nearest flower (3 observations)
    ...
    public override void Heuristic(float[] actionsOut) //in this case it is player input
    {
        ...
        //Combine the movements vectors and normalize
    ...
    /// <summary>
    /// Update the nwarest flower to the agent
    /// </summary>
    ...
    private void MoveToSafeRandomPosition(bool inFrontOfFlower)
    {
        ...
        while (!safePositionFound && attemptsRemaining > 0)
        {
            if (inFrontOfFlower)
            {
                ...
                //Position 10 to 20 cm in front of the flowe
            ...
            else
            {
                ...
                //Pick a random radius form the center of the area
                float radius = UnityEngine.Random.Range(2f, 7f);

                //Pick a random direction rotate around the y axis
    ...
    private void TriggerEnterOrStay(Collider other)
    {
        ...
        if (other.CompareTag("nectar"))
        {
            ...
            //Check is the closest collision point is close to the beak tip
            ...
            if (Vector3.Distance(beakTip.position, closestPointToBeakTip) < BeakTipRadius)
            {
                ...
                //Note: this is per fixed timestep, meaning it happens every 0.02 second, or 50x per second
                ...
                if (trainingMode)
                {
                    ...
                    AddReward(0.01f + bonus); //Total reward should be more or less 1 at the end of the episode
                }
