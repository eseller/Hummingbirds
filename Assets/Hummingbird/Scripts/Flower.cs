...
public class Flower : MonoBehaviour
{
    ...
    /// <summary>
    /// The flower has any nectar remaining
    /// </summary>
    ...
    /// </summary>
    /// <param name="amount">The amount of the nectar to remove</param>
    ...
    public void ResetFlower()
    {
        ...
        //Change the flower color to indicate that is full
